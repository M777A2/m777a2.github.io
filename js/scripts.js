$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;via=ZephlovesAnita&amp;hashtags=ZephLovesAnita&amp;count=horizontal"' +
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            // Event start date
            start: new Date('Dec 5, 2021 15:30'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '3a325616d03a6af99e1d0b24eecb6274') {
            ...
            $.post('https://script.google.com/macros/s/AKfycbwrsTG7YumsEio-AMA1VC1E6Aml-1InEjQZvjHaIT_ODFjOoFg/exec', data)
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> There is some issue with the server. Try disabling AdBlock.'));
                });
        }
    });
...
// Google map
function initMap() {
    var itc_kol = { lat: 37.651568, lng: -121.807218};
...
function initBBSRMap() {
    var la_fiesta = { lat: 37.651568, lng: -121.807218};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
